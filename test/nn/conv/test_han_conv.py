...
def test_han_conv():
    x_dict = {
        'author': paddle.randn([6, 16]),
        'paper': paddle.randn([5, 12]),
        'term': paddle.randn([4, 3])
    }
...
def test_han_conv_empty_tensor():
    ...
    edge_index_dict = {
        ('paper', 'to', 'author'): paddle.empty([2, 0], dtype='int64'),
        ('author', 'to', 'paper'): paddle.empty([2, 0], dtype='int64'),
        ('paper', 'to', 'paper'): paddle.empty([2, 0], dtype='int64'),
    }
