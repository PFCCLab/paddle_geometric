...
class HeteroConv(nn.Layer):
    ...
    In comparison to :meth:`paddle_geometric.nn.to_hetero`, this layer is
    ...
    Args:
        convs (Dict[Tuple[str, str, str], MessagePassing]): A dictionary
            holding a bipartite
            :class:`~paddle_geometric.nn.conv.MessagePassing` layer for each
        ...
        **kwargs_dict,
        ...
        Args:
            ...
            **kwargs_dict (optional): Additional forward arguments of
                ...
                :meth:`~paddle_geometric.nn.conv.HeteroConv.forward` via
