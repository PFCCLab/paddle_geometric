...
from paddle_geometric.data import Database, RocksDatabase, SQLiteDatabase
from paddle_geometric.data.data import BaseData
from paddle_geometric.data.database import Schema
from paddle_geometric.data.dataset import Dataset
        ...
        transform (callable, optional): A function/transform that takes in a
            :class:`~paddle_geometric.data.Data` or
                ...
                pre_filter (callable, optional): A function that takes in a
                    :class:`~paddle_geometric.data.Data` or
                    :class:`~paddle_geometric.data.HeteroData` object and returns a            boolean value, indicating whether the data object should be
