...
from paddle_geometric.utils import select
from paddle_geometric.utils._subgraph import hyper_subgraph
...
class HyperGraphData(Data):
    ...
    def __inc__(self, key: str, value: Any, *args: Any, **kwargs: Any) -> Any:
        if key == 'edge_index':
            return paddle.to_tensor([[self.num_nodes], [self.num_edges]])
        else:
